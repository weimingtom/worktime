 ...
 * Time: 9:19
 */
public class WidgetPreferencesActivity extends GenericPreferencesActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setTitle(R.string.pref_widget_category_title);
    }
    ...
    public String getPageViewTrackerId() {
        return TrackerConstants.PageView.Preferences.WIDGET_PREFERENCES;
    }
}
